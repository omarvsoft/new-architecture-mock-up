...
## Docker
<img src="https://www.docker.com/sites/default/files/whale_0.png" width="300"/>
...
>Additional labels can be configured in the fragments files yml. Consider that labels and selector must be the same